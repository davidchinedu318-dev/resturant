    ...
    <>
      ...
      <div className="min-h-screen bg-white flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans z-10">
        ...
        <div className="relative bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.12)] border border-neutral-100 overflow-hidden w-full max-w-4xl min-h-[600px] transition-all duration-300">
          ...
          <div className={`absolute top-0 h-full w-full md:w-1/2 transition-all duration-600 ease-in-out left-0 ${
            isSignUp 
            ...
            <form onSubmit={(e) => e.preventDefault()} className="bg-white flex items-center justify-center flex-col px-8 sm:px-14 h-full text-center py-8">
              <h1 className="text-3xl font-extrabold text-neutral-900 tracking-tight mb-2">Create Account</h1>
              
              <div className="flex gap-3 my-4">
                <button type="button" aria-label="GitHub" className="w-10 h-10 border border-neutral-200 rounded-full flex items-center justify-center text-neutral-700 hover:border-orange-500 hover:bg-orange-500 hover:text-white transition duration-300 cursor-pointer">
                  <FaGoogle size={18} />
                </button>
          ...
          <div className={`absolute top-0 h-full w-full md:w-1/2 transition-all duration-600 ease-in-out left-0 z-20 ${
            isSignUp 
          ...
          <div className={`hidden md:block absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-transform duration-600 ease-in-out z-40 ${
            isSignUp ? "-translate-x-full" : ""
          }`}>
            <div className={`relative bg-gradient-to-br from-orange-500 to-orange-600 text-white left-[-100%] h-full w-[200%] transition-transform duration-600 ease-in-out ${
              isSignUp ? "translate-x-1/2" : "translate-x-0"
            }`}>
              
              <div className={`absolute top-0 left-0 w-1/2 h-full flex flex-col justify-center items-center p-12 text-center transition-transform duration-600 ease-in-out ${
              ...
              <div className={`absolute top-0 right-0 w-1/2 h-full flex flex-col justify-center items-center p-12 text-center transition-transform duration-600 ease-in-out ${
